...
(function($) {
	...
	$.fn.quickPager = function(options) {
		...
		if(page.hasPreviousPageUnit()) {
			selector.append('<a href="'+ options.searchUrl +'" class="direction prevEnd"><span></span><span></span> Prev End</a>');
		}
		...
		if(page.hasNextPageUnit()) {
			selector.append('<a href="'+ options.searchUrl +'" class="direction nextEnd">Next End <span></span><span></span></a>');
		}
